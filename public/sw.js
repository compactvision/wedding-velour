const APP_VERSION = 'wedding-velour-v6';
...
<head>
  ...
  <title>Wedding Velour - hors ligne</title>
  <style>
    ...
    button{margin-top:24px;border:0;border-radius:12px;background:#8b1e1e;color:#fff;padding:13px 18px;font-weight:700}
  </style>
</head>
<body>
  <main>
