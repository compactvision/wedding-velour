...
export default function PaymentFailed({ reference }: { reference?: string }) {
    return (
        <>
            <Head title="Paiement non finalisé" />
            <main className="relative flex min-h-screen overflow-hidden bg-[#f7f3ec] px-4 py-6 text-stone-900 sm:px-6 sm:py-10">
                <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_10%_10%,rgba(190,137,58,0.16),transparent_28%),radial-gradient(circle_at_90%_90%,rgba(127,29,29,0.10),transparent_32%)]" />
                ...
                <div className="relative mx-auto flex w-full max-w-5xl flex-col">
                    ...
                    <section className="my-auto grid overflow-hidden rounded-[2rem] border border-white/80 bg-white/90 shadow-[0_30px_90px_rgba(52,38,22,0.14)] backdrop-blur md:grid-cols-[0.72fr_1fr]">
                        <div className="relative flex min-h-56 items-center justify-center overflow-hidden bg-stone-950 p-10 text-white md:min-h-[34rem]">
                            <div className="absolute inset-0 bg-[radial-gradient(circle_at_35%_25%,rgba(213,162,83,0.35),transparent_35%),linear-gradient(145deg,transparent,rgba(127,29,29,0.35))]" />
                            ...
                            <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-rose-300/30 bg-rose-950/50 shadow-[0_0_70px_rgba(244,63,94,0.2)]">
                                <CircleX
                                    className="h-11 w-11 text-rose-200"
                                    strokeWidth={1.6}
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-14">
                            <p className="text-xs font-bold tracking-[0.22em] text-rose-700 uppercase">
                                Paiement interrompu
                            </p>
                            ...
                            <p className="mt-4 max-w-xl text-[15px] leading-7 text-stone-600">
                                Rien n’est perdu. Votre événement et votre offre
                                sont conservés : vous pouvez relancer le
                                paiement quand vous le souhaitez.
                            </p>
                            ...
                            <div className="mt-5 flex gap-3 rounded-2xl border border-amber-200/80 bg-amber-50/80 p-4">
                                <ShieldCheck className="mt-0.5 h-5 w-5 shrink-0 text-amber-700" />
                                <p className="text-sm leading-6 text-amber-950">
                                    Votre offre sera activée uniquement après
